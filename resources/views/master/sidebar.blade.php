<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="{{route('customer')}}"><em class="fa fa-user">&nbsp;</em> Khách hàng</a></li>
            ...
            <li><a href="{{route('register-room')}}"><em class="fa fa-sign-in">&nbsp;</em> Thuê phòng </a></li>
            <li><a href="{{route('order')}}"><em class="fa fa-dollar">&nbsp;</em> Thanh toán</a></li>
            <hr>
